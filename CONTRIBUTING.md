...
- Clone the forked repository to your local development machine
   (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/Fabulous.Builders.git`).


### Environment Setup

To build Fabulous.Builders, you will need to install:
- the [.NET 8.0 SDK]
- an IDE of your preference
- Open the Fabulous.Builders.sln ith your preferred IDE and build the solution or execute one of the following commands:
```shell
dotnet build Fabulous.Builders.sln
```
...
Go to the [pull request page of Fabulous.Builders][PRs] and in the top
of the page it will ask you if you want to open a pull request from your newly created branch.

The title of the pull request should be descriptive of the work you did.


[GitHub issue]: https://github.com/edgarfgp/Fabulous.Builders/issues
[GitHub issues]: https://github.com/edgarfgp/Fabulous.Builders/issues
[GitHub releases page]: https://github.com/edgarfgp/Fabulous.Builders/releases
[PRs]: https://github.com/edgarfgp/Fabulous.Builders/pulls
